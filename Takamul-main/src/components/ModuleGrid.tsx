    ...
    <div className="mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {modules.map((module, index) => (
          <Card key={index} className="bg-white/90 backdrop-blur-md border border-blue-100 shadow-lg hover:shadow-2xl transition-all duration-500 group cursor-pointer hover:scale-105">
              ...
              <div className="flex items-center justify-center mb-3 space-x-2">
                <Button 
                  ...
                  className={`${module.status === 'active' 
                    ? 'bg-takamul-emerald-green hover:bg-green-600 shadow-lg' 
                    : 'bg-gray-400 cursor-not-allowed'
                  } text-white font-medium px-4 py-2 rounded-xl transition-all duration-300 ${isArabic ? 'font-cairo' : 'font-poppins'}`}
